...
export default function TripPackage() {
  ...
  useEffect(() => {
    if (packageName) {
      ...
      setHeroSectionData ([{ imglink: packages[packageName].featuredImageLink, title: packages[packageName].title, subtitle: packages[packageName].subtitle}])
    }  
  },[packageName])
  
  return (
    <div className="w-full">
      {heroSectionData.length > 0  &&  <HeroSection withSlider={false} data={heroSectionData} height={'80vh'} /> }
